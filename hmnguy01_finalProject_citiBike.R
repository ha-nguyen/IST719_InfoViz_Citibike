#IST719 - FINAL PROJECT - VISUALIZING CITI BIKE PROGRAM DATA 2014 
# Author - HA NGUYEN 
# file.name: hmnguy01_finalProject_citiBike.
#Loading library 
...
bike.Jan14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-01 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.Feb14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-02 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.Mar14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-03 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.Apr14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-04 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.May14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-05 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.Jun14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-06 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.Jul14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-07 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.Aug14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/2014-08 - Citi Bike trip data.csv", stringsAsFactors = F)
bike.Sep14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/201409-citibike-tripdata.csv", stringsAsFactors = F)
bike.Oct14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/201410-citibike-tripdata.csv", stringsAsFactors = F)
bike.Nov14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/201411-citibike-tripdata.csv", stringsAsFactors = F)
bike.Dec14 <- read.csv("/Users/akira_6686/Dropbox/SPRING_2015/IST719/FinalProject/dataset/2014-citibike-tripdata/201412-citibike-tripdata.csv", stringsAsFactors = F)

#Merge data into 2 parts
#Each part has different time series format 
bike1 <- rbind(bike.Jan14, bike.Feb14,bike.Mar14,bike.Apr14,bike.May14,bike.Jun14,bike.Jul14,bike.Aug14)
bike2 <- rbind(bike.Sep14,bike.Oct14,bike.Nov14,bike.Dec14)
...
bike14$age <- 2015  - bike14$birth.year
...
startime.dateAug <- strptime(bike.Aug14$starttime, "%Y-%m-%d %H:%M:%S", tz = "EST")
bike.Aug14$startime.weekday<- weekdays.POSIXt(startime.dateAug)
bike.Aug14$startime.day <-day(startime.dateAug)
bike.Aug14$startime.week<- week(startime.dateAug)
bike.Aug14$startime.weekinmon <- ceiling(bike.Aug14$startime.day/7)
bike.Aug14$startime.hour <- hour(startime.dateAug)
bike.Aug14$month <- month(startime.dateAug, label= T)

bike.Aug14$timeCat[bike.Aug14$startime.hour < 5 & bike.Aug14$startime.hour >= 0] <- "Night"
bike.Aug14$timeCat[bike.Aug14$startime.hour < 12 & bike.Aug14$startime.hour >= 5 ] <- "Morning"
bike.Aug14$timeCat[bike.Aug14$startime.hour < 19 & bike.Aug14$startime.hour >= 12 ] <- "Afternoon"
bike.Aug14$timeCat[bike.Aug14$startime.hour <= 23 & bike.Aug14$startime.hour >= 19 ] <- "Evening"
bike.Aug14$timeCat <- factor(bike.Aug14$timeCat, levels = c("Morning", "Afternoon", "Evening", "Night"))
...
bike14.use.demographics <- ddply(bike14.filter, c("ageCat", "gender"), summarise, mUse = length(gender))
